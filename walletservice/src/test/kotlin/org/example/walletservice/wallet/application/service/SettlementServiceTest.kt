...
import org.example.walletservice.wallet.adapter.out.persistence.repsitory.SpringDataJpaWalletRepository
import org.example.walletservice.wallet.adapter.out.persistence.repsitory.SpringDataJpaWalletTransactionRepository
...
class SettlementServiceTest(
    ...
    @Autowired private val loadWallerPort: LoadWallerPort,
    ...
    fun `should process settlement successfully`() {
        ...
        val updatedWallets =
            loadWallerPort.getWallets(jpaWalletEntities.map { it.userId }.toSet()).sortedBy { it.userId }
